...
Apartment.configure do |config|
  ...
  #
  # config.excluded_models = PublicSchemaModel.list
  ...
  # end
  #
  config.tenant_names = -> { School.pluck(:subdomain).map(&:downcase) }
...
# Apartment::Elevators::Subdomain.excluded_subdomains = Rails.application.secrets.tenant_excluded_subdomain
